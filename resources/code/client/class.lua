...
.monkeylead				{color: #774704;	font-size: 2;}
    ...
    virtual_eye = nil,
    selected_target = nil,
    active_mousedown_item = nil,
    mouseParams = "",
    mouseLocation = nil,
    mouseObject = nil,
    mouseControlObject = nil,
    middragtime = 0,
    middragatom = nil,
    parallax_layers = nil,
    parallax_layers_cached = nil,
    movingmob = nil,
    previous_turf = nil,
    dont_animate_parallax = nil,
    last_parallax_shift = nil,
    parallax_throttle = 0,
    parallax_movedir = 0,
    parallax_layers_max = 3,
    parallax_animate_timer = nil,
    adminhelptimerid = 0,
    current_ticket = nil,
    cache = {},
    ...
    move_delay = 0,
    area = nil,
    ambience_playing = nil,
    played = 0,
    player_age = -1,
    player_join_date = nil,
    related_accounts_ip = "Requires database",
    related_accounts_cid = "Requires database",
    account_join_date = nil,
    account_age = -1,
    void = nil,
    mouse_up_icon = nil,
    mouse_down_icon = nil,
    ...
    avgping = 0,
    connection_time = nil,
    connection_realtime = nil,
    connection_timeofday = nil,
    inprefs = 0,
    topiclimiter = nil,
    clicklimiter = nil,
    chatOutput = nil,
    credits = nil,
    player_details = nil,
    char_render_holders = nil,
    keys_held = {},
    next_move_dir_add = nil,
    next_move_dir_sub = nil,
